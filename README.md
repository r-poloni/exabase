...
The order of data entry is very important, because otherwise the contraints put on the database foreign keys to prevent corrupting the database will not be respected. The order should be
